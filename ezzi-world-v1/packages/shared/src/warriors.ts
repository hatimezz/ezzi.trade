...
export const WARRIOR_STATS = {
  KRONOS: { attack: 95, defense: 70, speed: 88, magic: 99, miningRate: 10 },
  KIRA: { attack: 88, defense: 65, speed: 92, magic: 75, miningRate: 3 },
  ATLAS: { attack: 72, defense: 80, speed: 85, magic: 60, miningRate: 1.5 },
  COSMOS: { attack: 80, defense: 85, speed: 70, magic: 97, miningRate: 8 },
  SYLVAN: { attack: 75, defense: 90, speed: 65, magic: 85, miningRate: 2 },
  SERAPH: { attack: 78, defense: 95, speed: 78, magic: 88, miningRate: 4 },
  SOLARIS: { attack: 90, defense: 98, speed: 75, magic: 95, miningRate: 10 },
  IGNITE: { attack: 85, defense: 60, speed: 98, magic: 55, miningRate: 2 },
} as const;
