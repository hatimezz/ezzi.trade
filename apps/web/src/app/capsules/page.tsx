...
import type { CapsuleTierInfo, CapsuleResult } from '@ezzi/shared';
...
export default function CapsulesPage() {
  const [selectedCapsule, setSelectedCapsule] = useState<CapsuleTierInfo | null>(null);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {capsules?.map((capsule: CapsuleTierInfo, index: number) => (
              <motion.div
                key={capsule.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
