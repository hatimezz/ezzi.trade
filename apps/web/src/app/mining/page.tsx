...
import type { NFT, MiningSession, ZoneInfo } from '@ezzi/shared';
...
export default function MiningPage() {
  ...
  const availableNfts = nfts?.filter((nft: NFT) => !nft.isStaked && nft.durability > 0);
        ...
        >
          ...
          {sessionsLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {sessions.map((session: MiningSession) => (
                <motion.div
                  key={session.id}
        ...
        >
          ...
          {historyLoading ? (
            ...
            <div className="space-y-4">
              {history.slice(0, 5).map((session: MiningSession) => (
                <div
                  key={session.id}
