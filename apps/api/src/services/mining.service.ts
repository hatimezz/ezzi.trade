...
import { realtimeMiningService } from './realtime-mining.service';
...
export class MiningService {
  ...
  async startMining(input: StartMiningInput) {
    ...
    realtimeMiningService.emitMiningStarted(input.userId, session[0]);
  ...
  async endMining(input: EndMiningInput) {
    ...
    // Emit real-time event
    realtimeMiningService.emitMiningEnded(
      input.userId,
      input.sessionId,
      actualEarnings,
