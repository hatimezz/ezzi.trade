...
function generateDescription(warrior: Warrior): string {
...
function generateCommonDescription(warrior: Warrior, variant: number): string {
  return `A common variant of ${warrior.displayName}. Variant #${variant} of the Genesis collection.`;
}

function generateRareDescription(warrior: Warrior, variant: number): string {
